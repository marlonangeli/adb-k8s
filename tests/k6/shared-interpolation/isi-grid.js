...
const scenario = "shared-isi-grid";
const endpoint = "/isi/idw";
const requestTimeout = __ENV.K6_HTTP_TIMEOUT || "180s";
...
const payload = open("./payloads/isi_idw.json");
...
export const handleSummary = createSummaryHandler({
  runName: __ENV.K6_RUN_NAME || "shared-isi-grid",
  scenario,
  service,
